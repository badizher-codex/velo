...
public sealed class LocalizationService
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> _strings = new()
    {
        ...
        ["history.loading"] = new() { ["es"]="Cargando…",["en"]="Loading…",["pt"]="Carregando…",["fr"]="Chargement…",["de"]="Wird geladen…",["zh"]="加载中…",["ru"]="Загрузка…",["ja"]="読み込み中…" },
        ["history.reload"] = new() { ["es"]="Recargar",["en"]="Reload",["pt"]="Recarregar",["fr"]="Recharger",["de"]="Neu laden",["zh"]="重新加载",["ru"]="Обновить",["ja"]="再読み込み" },
        ["history.matches"] = new() { ["es"]="{0} coincidencias para \"{1}\"",["en"]="{0} matches for \"{1}\"",["pt"]="{0} resultados para \"{1}\"",["fr"]="{0} résultats pour \"{1}\"",["de"]="{0} Treffer für \"{1}\"",["zh"]="\"{1}\" 找到 {0} 个匹配",["ru"]="{0} совпадений для \"{1}\"",["ja"]="\"{1}\" の検索結果 {0} 件" },
        ["tldr.no_content"] = new() { ["es"]="No se detectó contenido legible en esta página.",["en"]="No readable content found on this page.",["pt"]="Sem conteúdo legível nesta página.",["fr"]="Pas de contenu lisible sur cette page.",["de"]="Kein lesbarer Inhalt auf dieser Seite.",["zh"]="此页面未发现可读内容。",["ru"]="На этой странице нет читаемого содержимого.",["ja"]="このページに読み取り可能なコンテンツがありません。" },
        ["tldr.failed"] = new() { ["es"]="No se pudo generar el resumen.",["en"]="Could not generate a summary.",["pt"]="Não foi possível gerar o resumo.",["fr"]="Impossible de générer le résumé.",["de"]="Zusammenfassung konnte nicht erstellt werden.",["zh"]="无法生成摘要。",["ru"]="Не удалось создать резюме.",["ja"]="要約を生成できませんでした。" },

        // ── Code Helper context menu (Sprint 9A wire, v2.4.13) ───────────
        ["ctx.ai.code.menu"]            = new() { ["es"]="💻 Código",["en"]="💻 Code",["pt"]="💻 Código",["fr"]="💻 Code",["de"]="💻 Code",["zh"]="💻 代码",["ru"]="💻 Код",["ja"]="💻 コード" },
        ["ctx.ai.code.explain"]         = new() { ["es"]="Explicar este código",["en"]="Explain this code",["pt"]="Explicar este código",["fr"]="Expliquer ce code",["de"]="Diesen Code erklären",["zh"]="解释这段代码",["ru"]="Объяснить этот код",["ja"]="このコードを説明" },
        ["ctx.ai.code.debug"]           = new() { ["es"]="Buscar bugs",["en"]="Find bugs",["pt"]="Procurar bugs",["fr"]="Trouver des bugs",["de"]="Bugs finden",["zh"]="查找错误",["ru"]="Найти баги",["ja"]="バグを検出" },
        ["ctx.ai.code.optimize"]        = new() { ["es"]="Optimizar",["en"]="Optimize",["pt"]="Otimizar",["fr"]="Optimiser",["de"]="Optimieren",["zh"]="优化",["ru"]="Оптимизировать",["ja"]="最適化" },
        ["ctx.ai.code.comment"]         = new() { ["es"]="Añadir comentarios",["en"]="Add comments",["pt"]="Adicionar comentários",["fr"]="Ajouter des commentaires",["de"]="Kommentare hinzufügen",["zh"]="添加注释",["ru"]="Добавить комментарии",["ja"]="コメントを追加" },
        ["ctx.ai.code.error_handling"]  = new() { ["es"]="Añadir manejo de errores",["en"]="Add error handling",["pt"]="Adicionar tratamento de erros",["fr"]="Ajouter la gestion d'erreurs",["de"]="Fehlerbehandlung hinzufügen",["zh"]="添加错误处理",["ru"]="Добавить обработку ошибок",["ja"]="エラー処理を追加" },
        ["ctx.ai.code.translate"]       = new() { ["es"]="Traducir a…",["en"]="Translate to…",["pt"]="Traduzir para…",["fr"]="Traduire en…",["de"]="Übersetzen nach…",["zh"]="翻译为…",["ru"]="Перевести в…",["ja"]="変換先…" },
        ...
        ["settings.fp.aggressive"]      = new() { ["es"]="Agresivo",["en"]="Aggressive",["pt"]="Agressivo",["fr"]="Agressif",["de"]="Aggressiv",["zh"]="激进",["ru"]="Агрессивный",["ja"]="積極的" },
        ...
        ["settings.fp.balanced"]        = new() { ["es"]="Balanceado (Recomendado)",["en"]="Balanced (Recommended)",["pt"]="Balanceado (Recomendado)",["fr"]="Équilibré (Recommandé)",["de"]="Ausgewogen (Empfohlen)",["zh"]="平衡（推荐）",["ru"]="Сбалансированный (рекомендуется)",["ja"]="バランス（推奨）" },
        ...
        ["settings.dns.url"]            = new() { ["es"]="URL DOH",["en"]="DOH URL",["pt"]="URL DOH",["fr"]="URL DOH",["de"]="DOH-URL",["zh"]="DoH URL",["ru"]="URL DOH",["ja"]="DoH URL" },
        ...
        // v2.4.53's YouTube ad-block block shipped with its strings hardcoded in
        // Spanish (no x:Name, no key) — it was the only Spanish text left on an
        // English UI. Wired up here in v2.4.69.
        ["settings.ai.youtube_adblock"]      = new() { ["es"]="Bloquear anuncios en YouTube",["en"]="Block YouTube ads",["pt"]="Bloquear anúncios no YouTube",["fr"]="Bloquer les publicités YouTube",["de"]="YouTube-Werbung blockieren",["zh"]="屏蔽 YouTube 广告",["ru"]="Блокировать рекламу на YouTube",["ja"]="YouTubeの広告をブロック" },
        ["settings.ai.youtube_adblock.desc"] = new() { ["es"]="Salta pre-roll + mid-roll + overlay + cards patrocinadas en home/sidebar/search. Neutraliza el modal 'los bloqueadores no están permitidos'. El cambio aplica a pestañas nuevas — refrescá tabs YouTube ya abiertos para que tome efecto.",["en"]="Skips pre-roll + mid-roll + overlay + sponsored cards on home/sidebar/search. Neutralises the 'ad blockers are not allowed' modal. Applies to new tabs — refresh any YouTube tab you already have open.",["pt"]="Pula pre-roll + mid-roll + overlay + cards patrocinados em home/sidebar/busca. Neutraliza o modal 'bloqueadores não são permitidos'. Vale para novas abas — atualize as abas do YouTube já abertas.",["fr"]="Ignore pre-roll + mid-roll + overlay + cartes sponsorisées sur accueil/barre latérale/recherche. Neutralise la fenêtre « les bloqueurs de publicité ne sont pas autorisés ». S'applique aux nouveaux onglets — actualisez les onglets YouTube déjà ouverts.",["de"]="Überspringt Pre-Roll, Mid-Roll, Overlays und gesponserte Karten auf Startseite/Seitenleiste/Suche. Neutralisiert das Modal „Werbeblocker sind nicht erlaubt“. Gilt für neue Tabs — bereits geöffnete YouTube-Tabs neu laden.",["zh"]="跳过前贴片、中插、浮层广告以及首页/侧边栏/搜索中的赞助卡片。屏蔽“不允许使用广告拦截器”弹窗。对新标签页生效——请刷新已打开的 YouTube 标签页。",["ru"]="Пропускает пре-роллы, мид-роллы, оверлеи и спонсорские карточки на главной, в боковой панели и поиске. Нейтрализует окно «блокировщики рекламы не разрешены». Действует для новых вкладок — обновите уже открытые вкладки YouTube.",["ja"]="プレロール・ミッドロール・オーバーレイ、およびホーム／サイドバー／検索のスポンサーカードをスキップします。「広告ブロッカーは許可されていません」のモーダルを無効化します。新しいタブから有効です — 開いているYouTubeタブは再読み込みしてください。" },

        // S-C — VELO Sentinel, the embedded offline classifier.
        ["settings.sentinel.title"]     = new() { ["es"]="VELO Sentinel (clasificador local)",["en"]="VELO Sentinel (local classifier)",["pt"]="VELO Sentinel (classificador local)",["fr"]="VELO Sentinel (classificateur local)",["de"]="VELO Sentinel (lokaler Klassifikator)",["zh"]="VELO Sentinel（本地分类器）",["ru"]="VELO Sentinel (локальный классификатор)",["ja"]="VELO Sentinel（ローカル分類器）" },
        ["settings.sentinel.desc"]      = new() { ["es"]="Modelo de seguridad incrustado: clasifica dominios sin conexión, sin servidor y sin enviar nada. Complementa las listas de bloqueo — no las reemplaza.",["en"]="Embedded security model: classifies domains offline, with no server and nothing sent out. It complements the blocklists — it does not replace them.",["pt"]="Modelo de segurança incorporado: classifica domínios offline, sem servidor e sem enviar nada. Complementa as listas de bloqueio — não as substitui.",["fr"]="Modèle de sécurité intégré : classe les domaines hors ligne, sans serveur et sans rien envoyer. Il complète les listes de blocage — il ne les remplace pas.",["de"]="Eingebettetes Sicherheitsmodell: klassifiziert Domains offline, ohne Server und ohne etwas zu senden. Es ergänzt die Blocklisten — es ersetzt sie nicht.",["zh"]="内嵌安全模型：离线分类域名，无需服务器，不发送任何数据。它是屏蔽列表的补充，而非替代。",["ru"]="Встроенная модель безопасности: классифицирует домены офлайн, без сервера и без отправки данных. Дополняет блок-листы, а не заменяет их.",["ja"]="組み込みのセキュリティモデル：サーバー不要・送信なしでドメインをオフライン分類します。ブロックリストを置き換えるのではなく補完します。" },
        ["settings.sentinel.status"]    = new() { ["es"]="Estado",["en"]="Status",["pt"]="Estado",["fr"]="État",["de"]="Status",["zh"]="状态",["ru"]="Состояние",["ja"]="状態" },
        ["settings.sentinel.install"]   = new() { ["es"]="Sin modelo instalado. Se espera en:",["en"]="No model installed. Expected at:",["pt"]="Nenhum modelo instalado. Esperado em:",["fr"]="Aucun modèle installé. Attendu dans :",["de"]="Kein Modell installiert. Erwartet unter:",["zh"]="未安装模型。预期位置：",["ru"]="Модель не установлена. Ожидается в:",["ja"]="モデル未インストール。想定パス：" },
        ["settings.sentinel.enforce"]   = new() { ["es"]="Aplicar los veredictos de Sentinel",["en"]="Apply Sentinel verdicts",["pt"]="Aplicar os veredictos do Sentinel",["fr"]="Appliquer les verdicts de Sentinel",["de"]="Sentinel-Urteile anwenden",["zh"]="应用 Sentinel 判定",["ru"]="Применять вердикты Sentinel",["ja"]="Sentinelの判定を適用する" },
        // S-D — model download channel.
        ["settings.sentinel.download"]  = new() { ["es"]="Descargar modelo",["en"]="Download model",["pt"]="Baixar modelo",["fr"]="Télécharger le modèle",["de"]="Modell herunterladen",["zh"]="下载模型",["ru"]="Скачать модель",["ja"]="モデルをダウンロード" },
        ["settings.sentinel.checking"]  = new() { ["es"]="Buscando modelo…",["en"]="Checking for a model…",["pt"]="Procurando modelo…",["fr"]="Recherche du modèle…",["de"]="Suche nach Modell…",["zh"]="正在查找模型…",["ru"]="Поиск модели…",["ja"]="モデルを確認中…" },
        ["settings.sentinel.downloading"] = new() { ["es"]="Descargando",["en"]="Downloading",["pt"]="Baixando",["fr"]="Téléchargement",["de"]="Wird heruntergeladen",["zh"]="正在下载",["ru"]="Загрузка",["ja"]="ダウンロード中" },
        ["settings.sentinel.uptodate"]  = new() { ["es"]="No hay un modelo más nuevo disponible.",["en"]="No newer model available.",["pt"]="Nenhum modelo mais recente disponível.",["fr"]="Aucun modèle plus récent disponible.",["de"]="Kein neueres Modell verfügbar.",["zh"]="没有更新的模型。",["ru"]="Более новой модели нет.",["ja"]="新しいモデルはありません。" },
        ["settings.sentinel.installed"] = new() { ["es"]="Modelo v{0} instalado y verificado (SHA256).",["en"]="Model v{0} installed and verified (SHA256).",["pt"]="Modelo v{0} instalado e verificado (SHA256).",["fr"]="Modèle v{0} installé et vérifié (SHA256).",["de"]="Modell v{0} installiert und verifiziert (SHA256).",["zh"]="模型 v{0} 已安装并通过 SHA256 校验。",["ru"]="Модель v{0} установлена и проверена (SHA256).",["ja"]="モデル v{0} をインストールし、SHA256で検証しました。" },
        ["settings.sentinel.failed"]    = new() { ["es"]="No se pudo instalar el modelo:",["en"]="Could not install the model:",["pt"]="Não foi possível instalar o modelo:",["fr"]="Impossible d'installer le modèle :",["de"]="Modell konnte nicht installiert werden:",["zh"]="无法安装模型：",["ru"]="Не удалось установить модель:",["ja"]="モデルをインストールできませんでした："},
        ["settings.sentinel.enforce.desc"] = new() { ["es"]="Desactivado, Sentinel solo registra lo que habría bloqueado (modo sombra). Activalo cuando confíes en el modelo: recién entonces puede cancelar pedidos.",["en"]="When off, Sentinel only records what it would have blocked (shadow mode). Turn it on once you trust the model: only then can it cancel requests.",["pt"]="Desativado, o Sentinel apenas registra o que teria bloqueado (modo sombra). Ative quando confiar no modelo: só então poderá cancelar pedidos.",["fr"]="Désactivé, Sentinel enregistre seulement ce qu'il aurait bloqué (mode fantôme). Activez-le lorsque vous faites confiance au modèle : ce n'est qu'alors qu'il peut annuler des requêtes.",["de"]="Ausgeschaltet protokolliert Sentinel nur, was es blockiert hätte (Schattenmodus). Schalten Sie es ein, wenn Sie dem Modell vertrauen: erst dann kann es Anfragen abbrechen.",["zh"]="关闭时，Sentinel 仅记录它本会拦截的内容（影子模式）。当你信任该模型后再开启：届时它才能取消请求。",["ru"]="Когда выключено, Sentinel только записывает, что он заблокировал бы (теневой режим). Включите, когда доверитесь модели: только тогда он сможет отменять запросы.",["ja"]="オフの場合、Sentinelはブロックしたはずの対象を記録するだけです（シャドウモード）。モデルを信頼できたらオンにしてください。その時点で初めてリクエストを取り消せます。" },
        ...
        ["settings.ai.bookmark_autotag"] = new() { ["es"]="Auto-etiquetar marcadores con IA",["en"]="Auto-tag bookmarks with AI",["pt"]="Auto-etiquetar marcadores com IA",["fr"]="Étiqueter automatiquement les favoris avec l'IA",["de"]="Lesezeichen automatisch mit KI markieren",["zh"]="使用 AI 自动标记书签",["ru"]="Авто-теги для закладок с ИИ",["ja"]="AIでブックマークに自動タグ付け" },
        ["narration.title"]            = new() { ["es"]="VELO bloqueó esto",["en"]="VELO blocked this",["pt"]="VELO bloqueou isto",["fr"]="VELO a bloqué ceci",["de"]="VELO hat dies blockiert",["zh"]="VELO 已阻止",["ru"]="VELO заблокировал",["ja"]="VELOがブロック" },
        ["narration.dismiss"]          = new() { ["es"]="Cerrar",["en"]="Dismiss",["pt"]="Fechar",["fr"]="Fermer",["de"]="Schließen",["zh"]="关闭",["ru"]="Закрыть",["ja"]="閉じる" },
        ["clipboard.title"]            = new() { ["es"]="Historial del portapapeles",["en"]="Clipboard history",["pt"]="Histórico da área de transferência",["fr"]="Historique du presse-papiers",["de"]="Zwischenablage-Verlauf",["zh"]="剪贴板历史",["ru"]="История буфера обмена",["ja"]="クリップボード履歴" },
        ["clipboard.hint"]             = new() { ["es"]="Doble clic para pegar en el campo activo",["en"]="Double-click to paste into the active field",["pt"]="Duplo clique para colar no campo ativo",["fr"]="Double-clic pour coller dans le champ actif",["de"]="Doppelklick zum Einfügen ins aktive Feld",["zh"]="双击粘贴到当前字段",["ru"]="Двойной клик вставит в активное поле",["ja"]="ダブルクリックでアクティブフィールドに貼り付け" },
        ["clipboard.clear_all"]        = new() { ["es"]="Vaciar",["en"]="Clear all",["pt"]="Limpar tudo",["fr"]="Tout effacer",["de"]="Alles löschen",["zh"]="全部清除",["ru"]="Очистить всё",["ja"]="すべてクリア" },
        ["clipboard.empty"]            = new() { ["es"]="No hay textos capturados todavía.",["en"]="No captures yet.",["pt"]="Nenhuma captura ainda.",["fr"]="Aucune capture pour l'instant.",["de"]="Noch keine Aufzeichnungen.",["zh"]="尚无记录。",["ru"]="Пока нет записей.",["ja"]="まだ履歴がありません。" },
        ["settings.clipboard.title"]   = new() { ["es"]="Historial del portapapeles",["en"]="Clipboard history",["pt"]="Histórico da área de transferência",["fr"]="Historique du presse-papiers",["de"]="Zwischenablage-Verlauf",["zh"]="剪贴板历史",["ru"]="История буфера обмена",["ja"]="クリップボード履歴" },
        ["settings.clipboard.desc"]    = new() { ["es"]="Captura los últimos 20 textos copiados. Solo en memoria; se borra al cerrar VELO. Atajo: Ctrl+Shift+V.",["en"]="Keeps the last 20 copied texts. In memory only; cleared when VELO closes. Shortcut: Ctrl+Shift+V.",["pt"]="Mantém os últimos 20 textos copiados. Somente em memória; limpo ao fechar VELO. Atalho: Ctrl+Shift+V.",["fr"]="Conserve les 20 derniers textes copiés. En mémoire uniquement ; effacé à la fermeture de VELO. Raccourci : Ctrl+Maj+V.",["de"]="Speichert die letzten 20 kopierten Texte. Nur im Speicher; wird beim Schließen von VELO gelöscht. Tastenkürzel: Strg+Umschalt+V.",["zh"]="保留最近 20 个复制的文本。仅存于内存；关闭 VELO 时清除。快捷键：Ctrl+Shift+V。",["ru"]="Хранит последние 20 скопированных текстов. Только в памяти; очищается при закрытии VELO. Сочетание: Ctrl+Shift+V.",["ja"]="直近20件のコピーテキストを保持。メモリのみ、VELO終了時にクリア。ショートカット：Ctrl+Shift+V。" },
        ["settings.ai.bookmark_autotag.desc"] = new() { ["es"]="Genera 3-5 etiquetas temáticas al guardar un marcador.",["en"]="Generates 3-5 topical tags when saving a bookmark.",["pt"]="Gera 3-5 etiquetas temáticas ao salvar um marcador.",["fr"]="Génère 3-5 étiquettes thématiques lors de l'enregistrement d'un favori.",["de"]="Erzeugt 3-5 thematische Tags beim Speichern eines Lesezeichens.",["zh"]="保存书签时生成 3-5 个主题标签。",["ru"]="Создаёт 3-5 тематических тегов при сохранении закладки.",["ja"]="ブックマーク保存時に3-5個のトピックタグを生成。" },
        ["settings.ai.domain_age"]      = new() { ["es"]="Verificar edad del dominio (RDAP)",["en"]="Check domain age (RDAP)",["pt"]="Verificar idade do domínio (RDAP)",["fr"]="Vérifier l'âge du domaine (RDAP)",["de"]="Domain-Alter prüfen (RDAP)",["zh"]="检查域名年龄（RDAP）",["ru"]="Проверять возраст домена (RDAP)",["ja"]="ドメイン年齢を確認（RDAP）" },
        ["settings.ai.domain_age.desc"] = new() { ["es"]="Consulta IANA RDAP en páginas ya marcadas como sospechosas para detectar dominios recién registrados. Cero lookups en sites buenos.",["en"]="Queries IANA RDAP on already-flagged suspicious pages to spot freshly-registered domains. Zero lookups on clean browsing.",["pt"]="Consulta o IANA RDAP em páginas já marcadas como suspeitas para identificar domínios recém-registrados. Nenhuma consulta em sites normais.",["fr"]="Interroge IANA RDAP sur les pages déjà signalées comme suspectes pour repérer les domaines récemment enregistrés. Aucune requête sur la navigation normale.",["de"]="Fragt IANA RDAP auf bereits als verdächtig markierten Seiten ab, um frisch registrierte Domains zu erkennen. Keine Abfragen beim normalen Surfen.",["zh"]="对已标记为可疑的页面查询 IANA RDAP，识别新注册域名。正常浏览不发出查询。",["ru"]="Запрашивает IANA RDAP на уже отмеченных подозрительных страницах для выявления свежезарегистрированных доменов. На обычных сайтах запросов нет.",["ja"]="既に疑わしいと判定されたページでIANA RDAPに問い合わせ、新規登録ドメインを検出。通常の閲覧では問い合わせなし。" },
        ["perm.title"]          = new() { ["es"]="Permiso solicitado",["en"]="Permission request",["pt"]="Solicitação de permissão",["fr"]="Demande d'autorisation",["de"]="Berechtigungsanfrage",["zh"]="权限请求",["ru"]="Запрос разрешения",["ja"]="権限のリクエスト" },
        ["perm.body"]           = new() { ["es"]="«{0}» quiere usar: {1}",["en"]="\"{0}\" wants to use: {1}",["pt"]="\"{0}\" quer usar: {1}",["fr"]="« {0} » veut utiliser : {1}",["de"]="\"{0}\" möchte Folgendes verwenden: {1}",["zh"]="“{0}”想要使用：{1}",["ru"]="«{0}» запрашивает доступ: {1}",["ja"]="「{0}」が使用を求めています：{1}" },
        ["perm.allow"]          = new() { ["es"]="Permitir",["en"]="Allow",["pt"]="Permitir",["fr"]="Autoriser",["de"]="Erlauben",["zh"]="允许",["ru"]="Разрешить",["ja"]="許可" },
        ["perm.block"]          = new() { ["es"]="Bloquear",["en"]="Block",["pt"]="Bloquear",["fr"]="Bloquer",["de"]="Blockieren",["zh"]="阻止",["ru"]="Блокировать",["ja"]="ブロック" },
        ["perm.remember"]       = new() { ["es"]="Recordar mi decisión para este sitio",["en"]="Remember my decision for this site",["pt"]="Lembrar minha decisão para este site",["fr"]="Mémoriser ma décision pour ce site",["de"]="Meine Entscheidung für diese Website merken",["zh"]="记住我对此网站的选择",["ru"]="Запомнить решение для этого сайта",["ja"]="このサイトでの決定を記憶する" },
        ["perm.kind.camera"]        = new() { ["es"]="la cámara",["en"]="the camera",["pt"]="a câmera",["fr"]="la caméra",["de"]="die Kamera",["zh"]="摄像头",["ru"]="камеру",["ja"]="カメラ" },
        ["perm.kind.microphone"]    = new() { ["es"]="el micrófono",["en"]="the microphone",["pt"]="o microfone",["fr"]="le microphone",["de"]="das Mikrofon",["zh"]="麦克风",["ru"]="микрофон",["ja"]="マイク" },
        ["perm.kind.geolocation"]   = new() { ["es"]="tu ubicación",["en"]="your location",["pt"]="sua localização",["fr"]="votre position",["de"]="deinen Standort",["zh"]="您的位置",["ru"]="ваше местоположение",["ja"]="位置情報" },
        ["perm.kind.notifications"] = new() { ["es"]="notificaciones",["en"]="notifications",["pt"]="notificações",["fr"]="les notifications",["de"]="Benachrichtigungen",["zh"]="通知",["ru"]="уведомления",["ja"]="通知" },
        ["perm.kind.clipboard"]     = new() { ["es"]="leer el portapapeles",["en"]="read the clipboard",["pt"]="ler a área de transferência",["fr"]="lire le presse-papiers",["de"]="die Zwischenablage lesen",["zh"]="读取剪贴板",["ru"]="чтение буфера обмена",["ja"]="クリップボードの読み取り" },
        ["settings.privacy.ct_log"]      = new() { ["es"]="Verificar Transparencia de Certificados (crt.sh)",["en"]="Check Certificate Transparency (crt.sh)",["pt"]="Verificar Transparência de Certificados (crt.sh)",["fr"]="Vérifier la Transparence des Certificats (crt.sh)",["de"]="Zertifikatstransparenz prüfen (crt.sh)",["zh"]="检查证书透明度（crt.sh）",["ru"]="Проверять прозрачность сертификатов (crt.sh)",["ja"]="証明書の透明性を確認（crt.sh）" },
        ["settings.privacy.ct_log.desc"] = new() { ["es"]="Consulta crt.sh para cada dominio que visitás y avisa si falta en los CT logs públicos. Apagado por defecto: al activarlo, cada dominio visitado se envía a crt.sh.",["en"]="Queries crt.sh for every domain you visit and warns if it's missing from public CT logs. Off by default: when on, every visited domain is sent to crt.sh.",["pt"]="Consulta o crt.sh para cada domínio que você visita e avisa se ele estiver ausente dos CT logs públicos. Desativado por padrão: ao ativar, cada domínio visitado é enviado ao crt.sh.",["fr"]="Interroge crt.sh pour chaque domaine que vous visitez et alerte s'il est absent des journaux CT publics. Désactivé par défaut : une fois activé, chaque domaine visité est envoyé à crt.sh.",["de"]="Fragt crt.sh für jede besuchte Domain ab und warnt, wenn sie in den öffentlichen CT-Logs fehlt. Standardmäßig aus: wenn aktiviert, wird jede besuchte Domain an crt.sh gesendet.",["zh"]="对你访问的每个域名查询 crt.sh，若其不在公开 CT 日志中则发出警告。默认关闭：开启后，每个访问的域名都会发送到 crt.sh。",["ru"]="Запрашивает crt.sh для каждого посещённого домена и предупреждает, если он отсутствует в публичных CT-логах. По умолчанию выключено: при включении каждый посещённый домен отправляется на crt.sh.",["ja"]="訪問する各ドメインについて crt.sh に問い合わせ、公開CTログに存在しない場合に警告します。既定は無効：有効にすると、訪問した各ドメインが crt.sh に送信されます。" },
        ...
        ["onboarding.s3.level"]         = new() { ["es"]="Nivel: BALANCEADO (privado y compatible)",["en"]="Level: BALANCED (private and compatible)",["pt"]="Nível: BALANCEADO (privado e compatível)",["fr"]="Niveau : ÉQUILIBRÉ (privé et compatible)",["de"]="Stufe: AUSGEWOGEN (privat und kompatibel)",["zh"]="级别：平衡（隐私且兼容）",["ru"]="Уровень: СБАЛАНСИРОВАННЫЙ (приватный и совместимый)",["ja"]="レベル：バランス（プライベートかつ互換）" },
        ...
        // ── Threats panel: why was this blocked (v2.4.63) ─────────────────
        // Shown inline on every entry, no AI needed. Generic per category —
        // says what that kind of request typically does, not what this exact
        // domain does (that's what the "Explain" button is for).
        ["threatspanel.why.tracker"]     = new() { ["es"]="Rastreador: registra qué páginas visitás para armar un perfil tuyo a través de distintos sitios.",["en"]="Tracker: records which pages you visit to build a profile of you across different sites.",["pt"]="Rastreador: registra quais páginas você visita para montar um perfil seu em vários sites.",["fr"]="Traqueur : enregistre les pages que vous visitez pour constituer un profil de vous sur plusieurs sites.",["de"]="Tracker: zeichnet auf, welche Seiten Sie besuchen, um ein seitenübergreifendes Profil von Ihnen zu erstellen.",["zh"]="跟踪器：记录您访问的页面，以便跨站点建立您的画像。",["ru"]="Трекер: записывает, какие страницы вы посещаете, чтобы составить ваш профиль на разных сайтах.",["ja"]="トラッカー：閲覧したページを記録し、サイトをまたいであなたのプロファイルを作成します。" },
        ["threatspanel.why.malware"]     = new() { ["es"]="Malware: este dominio está asociado a software dañino, phishing o robo de credenciales.",["en"]="Malware: this domain is associated with harmful software, phishing or credential theft.",["pt"]="Malware: este domínio está associado a software nocivo, phishing ou roubo de credenciais.",["fr"]="Malware : ce domaine est associé à des logiciels malveillants, du phishing ou du vol d'identifiants.",["de"]="Malware: Diese Domain steht mit Schadsoftware, Phishing oder Zugangsdatendiebstahl in Verbindung.",["zh"]="恶意软件：该域名与恶意软件、钓鱼或凭据窃取有关。",["ru"]="Вредоносное ПО: этот домен связан с вредоносным софтом, фишингом или кражей учётных данных.",["ja"]="マルウェア：このドメインは有害なソフトウェア、フィッシング、認証情報の窃取に関連しています。" },
        ["threatspanel.why.ads"]         = new() { ["es"]="Red publicitaria: sirve anuncios y suele seguir tu navegación para segmentarlos.",["en"]="Ad network: serves ads and usually follows your browsing to target them.",["pt"]="Rede de anúncios: exibe anúncios e costuma seguir sua navegação para segmentá-los.",["fr"]="Régie publicitaire : diffuse des publicités et suit généralement votre navigation pour les cibler.",["de"]="Werbenetzwerk: liefert Anzeigen aus und verfolgt Ihr Surfverhalten zur Zielgruppenansprache.",["zh"]="广告网络：投放广告，通常会跟踪您的浏览行为以进行定向。",["ru"]="Рекламная сеть: показывает рекламу и обычно отслеживает ваши переходы для таргетинга.",["ja"]="広告ネットワーク：広告を配信し、ターゲティングのために閲覧行動を追跡するのが一般的です。" },
        ["threatspanel.why.fingerprint"] = new() { ["es"]="Fingerprinting: intenta identificar tu equipo por sus características (canvas, fuentes, hardware) aunque borres las cookies.",["en"]="Fingerprinting: tries to identify your device by its characteristics (canvas, fonts, hardware) even if you clear cookies.",["pt"]="Fingerprinting: tenta identificar seu dispositivo pelas características (canvas, fontes, hardware) mesmo que você limpe os cookies.",["fr"]="Empreinte numérique : tente d'identifier votre appareil par ses caractéristiques (canvas, polices, matériel) même si vous effacez les cookies.",["de"]="Fingerprinting: versucht, Ihr Gerät anhand seiner Merkmale (Canvas, Schriften, Hardware) zu identifizieren, selbst wenn Sie Cookies löschen.",["zh"]="指纹识别：即使您清除 Cookie，也会尝试通过设备特征（canvas、字体、硬件）识别您。",["ru"]="Цифровой отпечаток: пытается опознать ваше устройство по характеристикам (canvas, шрифты, железо), даже если вы очистите куки.",["ja"]="フィンガープリント：Cookieを消しても、端末の特徴（canvas・フォント・ハードウェア）から識別しようとします。" },
        ["threatspanel.why.script"]      = new() { ["es"]="Script sospechoso: el código que sirve este dominio coincide con patrones usados para espiar o alterar la página.",["en"]="Suspicious script: the code this domain serves matches patterns used to spy on or tamper with the page.",["pt"]="Script suspeito: o código servido por este domínio corresponde a padrões usados para espionar ou alterar a página.",["fr"]="Script suspect : le code servi par ce domaine correspond à des schémas utilisés pour espionner ou altérer la page.",["de"]="Verdächtiges Skript: Der von dieser Domain gelieferte Code entspricht Mustern, mit denen Seiten ausgespäht oder manipuliert werden.",["zh"]="可疑脚本：该域名提供的代码符合用于窥探或篡改页面的模式。",["ru"]="Подозрительный скрипт: код с этого домена совпадает с шаблонами слежки или подмены содержимого страницы.",["ja"]="不審なスクリプト：このドメインが配信するコードは、ページの盗聴や改ざんに使われるパターンと一致します。" },
        ["threatspanel.why.social"]      = new() { ["es"]="Widget social: los botones de «me gusta» o «compartir» avisan a la red social que visitaste esta página, aunque no los toques.",["en"]="Social widget: like and share buttons tell the social network you visited this page, even if you never click them.",["pt"]="Widget social: os botões de curtir e compartilhar avisam a rede social que você visitou esta página, mesmo sem clicar.",["fr"]="Widget social : les boutons « j'aime » et « partager » signalent au réseau social que vous avez visité cette page, même sans cliquer.",["de"]="Social-Widget: „Gefällt mir\"- und Teilen-Buttons melden dem sozialen Netzwerk Ihren Besuch dieser Seite, auch ohne Klick.",["zh"]="社交组件：点赞和分享按钮会告知社交网络您访问了此页面，即使您从未点击。",["ru"]="Социальный виджет: кнопки «нравится» и «поделиться» сообщают соцсети о вашем визите, даже если вы их не нажимали.",["ja"]="ソーシャルウィジェット：「いいね」や共有ボタンは、押さなくても訪問したことをSNSに伝えます。" },
        ["threatspanel.why.other"]       = new() { ["es"]="Petición bloqueada por una regla de seguridad de VELO.",["en"]="Request blocked by a VELO security rule.",["pt"]="Solicitação bloqueada por uma regra de segurança do VELO.",["fr"]="Requête bloquée par une règle de sécurité de VELO.",["de"]="Anfrage durch eine VELO-Sicherheitsregel blockiert.",["zh"]="请求已被 VELO 的安全规则阻止。",["ru"]="Запрос заблокирован правилом безопасности VELO.",["ja"]="VELOのセキュリティルールによりリクエストをブロックしました。" },
        ["threatspanel.why.detected"]    = new() { ["es"]="Detectado por {0}.",["en"]="Detected by {0}.",["pt"]="Detectado por {0}.",["fr"]="Détecté par {0}.",["de"]="Erkannt durch {0}.",["zh"]="由 {0} 检测。",["ru"]="Обнаружено: {0}.",["ja"]="検出元：{0}。" },

        ["threatspanel.source.goldenlist"]    = new() { ["es"]="la Golden List de VELO",["en"]="VELO's Golden List",["pt"]="a Golden List do VELO",["fr"]="la Golden List de VELO",["de"]="die Golden List von VELO",["zh"]="VELO 的 Golden List",["ru"]="Golden List VELO",["ja"]="VELOのGolden List" },
        ["threatspanel.source.malwaredex"]    = new() { ["es"]="tu Malwaredex local",["en"]="your local Malwaredex",["pt"]="seu Malwaredex local",["fr"]="votre Malwaredex local",["de"]="Ihre lokale Malwaredex",["zh"]="您的本地 Malwaredex",["ru"]="ваш локальный Malwaredex",["ja"]="ローカルのMalwaredex" },
        ["threatspanel.source.aiengine"]      = new() { ["es"]="el análisis con IA",["en"]="AI analysis",["pt"]="a análise com IA",["fr"]="l'analyse par IA",["de"]="die KI-Analyse",["zh"]="AI 分析",["ru"]="ИИ-анализ",["ja"]="AI解析" },
        ["threatspanel.source.userrule"]      = new() { ["es"]="una regla tuya",["en"]="one of your own rules",["pt"]="uma regra sua",["fr"]="une de vos règles",["de"]="eine Ihrer eigenen Regeln",["zh"]="您自己的规则",["ru"]="ваше собственное правило",["ja"]="あなたが設定したルール" },
        ["threatspanel.source.staticlist"]    = new() { ["es"]="la lista integrada",["en"]="the built-in list",["pt"]="a lista integrada",["fr"]="la liste intégrée",["de"]="die integrierte Liste",["zh"]="内置列表",["ru"]="встроенный список",["ja"]="内蔵リスト" },
        ["threatspanel.source.requestguard"]  = new() { ["es"]="RequestGuard (blocklist y heurísticas)",["en"]="RequestGuard (blocklist and heuristics)",["pt"]="RequestGuard (blocklist e heurísticas)",["fr"]="RequestGuard (blocklist et heuristiques)",["de"]="RequestGuard (Blocklist und Heuristiken)",["zh"]="RequestGuard（黑名单与启发式）",["ru"]="RequestGuard (чёрный список и эвристики)",["ja"]="RequestGuard（ブロックリストとヒューリスティック）" },
        ["threatspanel.source.downloadguard"] = new() { ["es"]="DownloadGuard",["en"]="DownloadGuard",["pt"]="DownloadGuard",["fr"]="DownloadGuard",["de"]="DownloadGuard",["zh"]="DownloadGuard",["ru"]="DownloadGuard",["ja"]="DownloadGuard" },

        ["threatspanel.action.explain"]  = new() { ["es"]="Explicar",["en"]="Explain",["pt"]="Explicar",["fr"]="Expliquer",["de"]="Erklären",["zh"]="解释",["ru"]="Объяснить",["ja"]="説明" },
        ["threatspanel.action.allow"]    = new() { ["es"]="Aprobar",["en"]="Allow",["pt"]="Permitir",["fr"]="Autoriser",["de"]="Zulassen",["zh"]="允许",["ru"]="Разрешить",["ja"]="許可" },
        ["threatspanel.action.report"]   = new() { ["es"]="Reportar",["en"]="Report",["pt"]="Reportar",["fr"]="Signaler",["de"]="Melden",["zh"]="举报",["ru"]="Сообщить",["ja"]="報告" },
        ["threatspanel.action.export"]   = new() { ["es"]="Exportar sesión JSON",["en"]="Export session as JSON",["pt"]="Exportar sessão em JSON",["fr"]="Exporter la session en JSON",["de"]="Sitzung als JSON exportieren",["zh"]="将会话导出为 JSON",["ru"]="Экспорт сессии в JSON",["ja"]="セッションをJSONで書き出す" },
        ["threatspanel.action.clear"]    = new() { ["es"]="Limpiar lista",["en"]="Clear list",["pt"]="Limpar lista",["fr"]="Effacer la liste",["de"]="Liste leeren",["zh"]="清空列表",["ru"]="Очистить список",["ja"]="リストを消去" },

        // ── Certificate interstitial (v2.4.62 P2-C) ───────────────────────
        ["cert.page.title"]             = new() { ["es"]="Conexión no privada",["en"]="Connection not private",["pt"]="Conexão não privada",["fr"]="Connexion non privée",["de"]="Verbindung nicht privat",["zh"]="连接不是私密连接",["ru"]="Подключение не защищено",["ja"]="接続は保護されていません" },
        ["cert.page.heading"]           = new() { ["es"]="Tu conexión con {0} no es privada",["en"]="Your connection to {0} is not private",["pt"]="Sua conexão com {0} não é privada",["fr"]="Votre connexion à {0} n'est pas privée",["de"]="Ihre Verbindung zu {0} ist nicht privat",["zh"]="您与 {0} 的连接不是私密连接",["ru"]="Ваше подключение к {0} не защищено",["ja"]="{0} への接続は保護されていません" },
        ["cert.page.body"]              = new() { ["es"]="VELO detuvo la carga porque el certificado del sitio no es válido. Alguien podría estar interceptando la conexión para leer lo que envías (contraseñas, mensajes, datos de pago).",["en"]="VELO stopped the page from loading because the site's certificate is invalid. Someone may be intercepting the connection to read what you send (passwords, messages, payment details).",["pt"]="O VELO interrompeu o carregamento porque o certificado do site é inválido. Alguém pode estar interceptando a conexão para ler o que você envia (senhas, mensagens, dados de pagamento).",["fr"]="VELO a interrompu le chargement car le certificat du site est invalide. Quelqu'un pourrait intercepter la connexion pour lire ce que vous envoyez (mots de passe, messages, données de paiement).",["de"]="VELO hat das Laden gestoppt, weil das Zertifikat der Website ungültig ist. Möglicherweise fängt jemand die Verbindung ab, um mitzulesen, was Sie senden (Passwörter, Nachrichten, Zahlungsdaten).",["zh"]="VELO 已阻止页面加载，因为该网站的证书无效。可能有人正在拦截连接以读取您发送的内容（密码、消息、付款信息）。",["ru"]="VELO остановил загрузку: сертификат сайта недействителен. Кто-то может перехватывать соединение и читать то, что вы отправляете (пароли, сообщения, платёжные данные).",["ja"]="サイトの証明書が無効なため、VELOは読み込みを中止しました。誰かが接続を傍受し、送信内容（パスワード、メッセージ、決済情報）を読み取っている可能性があります。" },
        ["cert.page.back"]              = new() { ["es"]="Volver a un sitio seguro",["en"]="Back to safety",["pt"]="Voltar para um site seguro",["fr"]="Revenir en sécurité",["de"]="Zurück zur Sicherheit",["zh"]="返回安全页面",["ru"]="Вернуться в безопасное место",["ja"]="安全なページに戻る" },
        ["cert.page.proceed"]           = new() { ["es"]="Continuar de todos modos (no seguro)",["en"]="Continue anyway (not safe)",["pt"]="Continuar mesmo assim (não seguro)",["fr"]="Continuer quand même (non sécurisé)",["de"]="Trotzdem fortfahren (unsicher)",["zh"]="仍要继续（不安全）",["ru"]="Всё равно продолжить (небезопасно)",["ja"]="それでも続行（安全ではありません）" },
        ["cert.page.proceedhint"]       = new() { ["es"]="Solo si sabés exactamente por qué el certificado falla. La excepción dura hasta que cierres esta pestaña.",["en"]="Only if you know exactly why the certificate fails. The exception lasts until you close this tab.",["pt"]="Somente se você souber exatamente por que o certificado falha. A exceção dura até você fechar esta aba.",["fr"]="Uniquement si vous savez exactement pourquoi le certificat échoue. L'exception dure jusqu'à la fermeture de cet onglet.",["de"]="Nur wenn Sie genau wissen, warum das Zertifikat fehlschlägt. Die Ausnahme gilt, bis Sie diesen Tab schließen.",["zh"]="仅当您明确知道证书失败的原因时。该例外在您关闭此标签页前有效。",["ru"]="Только если вы точно знаете, почему сертификат недействителен. Исключение действует до закрытия вкладки.",["ja"]="証明書が無効な理由を正確に把握している場合のみ。この例外はタブを閉じるまで有効です。" },
        ["cert.page.details"]           = new() { ["es"]="Detalle técnico",["en"]="Technical detail",["pt"]="Detalhe técnico",["fr"]="Détail technique",["de"]="Technisches Detail",["zh"]="技术细节",["ru"]="Технические детали",["ja"]="技術的な詳細" },
        ...
        // ── Import wizard (Phase 3 / Sprint 4) ───────────────────────────
        ["menu.import"]                  = new() { ["es"]="📥  Importar de otro navegador",["en"]="📥  Import from another browser",["pt"]="📥  Importar de outro navegador",["fr"]="📥  Importer d'un autre navigateur",["de"]="📥  Aus anderem Browser importieren",["zh"]="📥  从其他浏览器导入",["ru"]="📥  Импорт из другого браузера",["ja"]="📥  他のブラウザからインポート" },
        ["import.title"]                 = new() { ["es"]="Importar de otro navegador",["en"]="Import from another browser",["pt"]="Importar de outro navegador",["fr"]="Importer d'un autre navigateur",["de"]="Aus anderem Browser importieren",["zh"]="从其他浏览器导入",["ru"]="Импорт из другого браузера",["ja"]="他のブラウザからインポート" },
        ["import.none_detected"]         = new() { ["es"]="No se detectó ningún navegador instalado en este equipo.\n\nVELO busca Chrome, Edge, Brave, Vivaldi, Opera y Firefox.",["en"]="No installed browsers detected on this machine.\n\nVELO looks for Chrome, Edge, Brave, Vivaldi, Opera and Firefox.",["pt"]="Nenhum navegador instalado detectado nesta máquina.\n\nO VELO procura Chrome, Edge, Brave, Vivaldi, Opera e Firefox.",["fr"]="Aucun navigateur installé détecté.\n\nVELO recherche Chrome, Edge, Brave, Vivaldi, Opera et Firefox.",["de"]="Keine installierten Browser erkannt.\n\nVELO sucht nach Chrome, Edge, Brave, Vivaldi, Opera und Firefox.",["zh"]="未在此设备上检测到已安装的浏览器。\n\nVELO 查找 Chrome、Edge、Brave、Vivaldi、Opera 和 Firefox。",["ru"]="На этом устройстве не найдено установленных браузеров.\n\nVELO ищет Chrome, Edge, Brave, Vivaldi, Opera и Firefox.",["ja"]="このマシンにインストールされたブラウザが見つかりません。\n\nVELOはChrome、Edge、Brave、Vivaldi、Opera、Firefoxを探します。" },
        ["import.detected_body"]         = new() { ["es"]="Detectamos {0} navegador(es) instalado(s):\n\n{1}\n\nSe importará desde el primero (marcadores + historial). Las contraseñas se piden por separado.\n\n¿Continuar?",["en"]="Detected {0} installed browser(s):\n\n{1}\n\nImport will run on the first listed (bookmarks + history). Passwords are confirmed separately.\n\nContinue?",["pt"]="Detectados {0} navegador(es) instalado(s):\n\n{1}\n\nA importação rodará no primeiro listado (favoritos + histórico). As senhas são confirmadas separadamente.\n\nContinuar?",["fr"]="{0} navigateur(s) installé(s) détecté(s) :\n\n{1}\n\nL'import portera sur le premier listé (favoris + historique). Les mots de passe sont confirmés séparément.\n\nContinuer ?",["de"]="{0} installierte Browser erkannt:\n\n{1}\n\nDer Import läuft für den ersten in der Liste (Lesezeichen + Verlauf). Passwörter werden separat bestätigt.\n\nFortfahren?",["zh"]="检测到 {0} 个已安装的浏览器：\n\n{1}\n\n导入将从列表中第一个开始（书签 + 历史）。密码单独确认。\n\n是否继续？",["ru"]="Найдено {0} установленных браузеров:\n\n{1}\n\nИмпорт начнётся с первого в списке (закладки + история). Пароли подтверждаются отдельно.\n\nПродолжить?",["ja"]="インストール済みブラウザを {0} 個検出：\n\n{1}\n\nリスト先頭からインポートします（ブックマーク + 履歴）。パスワードは別途確認。\n\n続行しますか？" },
        ["import.confirm_passwords"]     = new() { ["es"]="¿También importar las contraseñas guardadas en {0}?\n\n• Las contraseñas se descifran con tu cuenta de Windows actual (DPAPI) y se guardan en tu Vault local encriptado.\n• VELO nunca envía nada a ningún servidor.\n• El Vault debe estar desbloqueado.\n\n(Firefox: no soportado en esta versión.)",["en"]="Also import the passwords saved in {0}?\n\n• Passwords are decrypted with your current Windows account (DPAPI) and stored in your local encrypted Vault.\n• VELO never sends anything to a server.\n• The Vault must be unlocked.\n\n(Firefox: not supported in this version.)",["pt"]="Também importar as senhas salvas em {0}?\n\n• As senhas são descriptografadas com sua conta atual do Windows (DPAPI) e guardadas no seu Vault local criptografado.\n• O VELO nunca envia nada a um servidor.\n• O Vault deve estar desbloqueado.\n\n(Firefox: não suportado nesta versão.)",["fr"]="Importer également les mots de passe enregistrés dans {0} ?\n\n• Les mots de passe sont déchiffrés avec votre compte Windows actuel (DPAPI) et stockés dans votre coffre local chiffré.\n• VELO n'envoie rien à un serveur.\n• Le coffre doit être déverrouillé.\n\n(Firefox : non pris en charge dans cette version.)",["de"]="Auch die in {0} gespeicherten Passwörter importieren?\n\n• Die Passwörter werden mit Ihrem aktuellen Windows-Konto (DPAPI) entschlüsselt und im lokalen verschlüsselten Tresor gespeichert.\n• VELO sendet nichts an einen Server.\n• Der Tresor muss entsperrt sein.\n\n(Firefox: in dieser Version nicht unterstützt.)",["zh"]="是否也导入 {0} 中保存的密码？\n\n• 使用您当前的 Windows 帐户 (DPAPI) 解密密码，并存储到本地加密 Vault。\n• VELO 不向任何服务器发送数据。\n• Vault 必须已解锁。\n\n（Firefox：此版本不支持。）",["ru"]="Импортировать также пароли из {0}?\n\n• Пароли расшифровываются вашей учётной записью Windows (DPAPI) и сохраняются в локальное зашифрованное хранилище.\n• VELO ничего не отправляет на серверы.\n• Хранилище должно быть разблокировано.\n\n(Firefox: не поддерживается в этой версии.)",["ja"]="{0} に保存されたパスワードもインポートしますか？\n\n• パスワードは現在のWindowsアカウント（DPAPI）で復号され、ローカルの暗号化Vaultに保存されます。\n• VELOはサーバーに何も送信しません。\n• Vaultはロック解除されている必要があります。\n\n（Firefox：このバージョンではサポートされません。）" },
        ["import.done.ok"]               = new() { ["es"]="✓ Importación completada desde {0}.",["en"]="✓ Import complete from {0}.",["pt"]="✓ Importação concluída de {0}.",["fr"]="✓ Import terminé depuis {0}.",["de"]="✓ Import abgeschlossen von {0}.",["zh"]="✓ 已完成从 {0} 导入。",["ru"]="✓ Импорт из {0} завершён.",["ja"]="✓ {0} からのインポート完了。" },
        ["import.done.partial"]          = new() { ["es"]="⚠ Importación completada desde {0} con errores.",["en"]="⚠ Import from {0} completed with errors.",["pt"]="⚠ Importação de {0} concluída com erros.",["fr"]="⚠ Import depuis {0} terminé avec des erreurs.",["de"]="⚠ Import von {0} mit Fehlern abgeschlossen.",["zh"]="⚠ 从 {0} 的导入完成但出现错误。",["ru"]="⚠ Импорт из {0} завершён с ошибками.",["ja"]="⚠ {0} からのインポートはエラー付きで完了。" },
        ["import.summary.bookmarks"]     = new() { ["es"]="marcadores",["en"]="bookmarks",["pt"]="favoritos",["fr"]="favoris",["de"]="Lesezeichen",["zh"]="书签",["ru"]="закладок",["ja"]="ブックマーク" },
        ["import.summary.history"]       = new() { ["es"]="entradas de historial",["en"]="history entries",["pt"]="entradas de histórico",["fr"]="entrées d'historique",["de"]="Verlaufseinträge",["zh"]="历史条目",["ru"]="записей истории",["ja"]="履歴エントリ" },
        ["import.summary.passwords"]     = new() { ["es"]="contraseñas",["en"]="passwords",["pt"]="senhas",["fr"]="mots de passe",["de"]="Passwörter",["zh"]="密码",["ru"]="паролей",["ja"]="パスワード" },
        ["import.warnings"]              = new() { ["es"]="Avisos:",["en"]="Warnings:",["pt"]="Avisos:",["fr"]="Avertissements :",["de"]="Warnungen:",["zh"]="警告：",["ru"]="Предупреждения:",["ja"]="警告：" },
        ["import.errors"]                = new() { ["es"]="Errores:",["en"]="Errors:",["pt"]="Erros:",["fr"]="Erreurs :",["de"]="Fehler:",["zh"]="错误：",["ru"]="Ошибки:",["ja"]="エラー：" },
        ["import.fatal"]                 = new() { ["es"]="No se pudo completar la importación: {0}",["en"]="Could not complete the import: {0}",["pt"]="Não foi possível concluir a importação: {0}",["fr"]="Impossible de terminer l'import : {0}",["de"]="Import konnte nicht abgeschlossen werden: {0}",["zh"]="无法完成导入：{0}",["ru"]="Не удалось завершить импорт: {0}",["ja"]="インポートを完了できませんでした：{0}" },

        // ── Autofill (Phase 3 / Sprint 5) ────────────────────────────────
        ["autofill.use_saved"]           = new() { ["es"]="¿Usar contraseña guardada?",["en"]="Use saved password?",["pt"]="Usar senha salva?",["fr"]="Utiliser le mot de passe enregistré ?",["de"]="Gespeichertes Passwort verwenden?",["zh"]="使用已保存的密码？",["ru"]="Использовать сохранённый пароль?",["ja"]="保存されたパスワードを使う？" },
        ["autofill.use"]                 = new() { ["es"]="Usar",["en"]="Use",["pt"]="Usar",["fr"]="Utiliser",["de"]="Verwenden",["zh"]="使用",["ru"]="Использовать",["ja"]="使う" },
        ["autofill.dismiss"]             = new() { ["es"]="No",["en"]="Dismiss",["pt"]="Não",["fr"]="Ignorer",["de"]="Verwerfen",["zh"]="不用",["ru"]="Скрыть",["ja"]="閉じる" },
        ["autofill.save_prompt"]         = new() { ["es"]="¿Guardar esta contraseña en VELO Vault?",["en"]="Save this password to VELO Vault?",["pt"]="Salvar esta senha no VELO Vault?",["fr"]="Enregistrer ce mot de passe dans le coffre VELO ?",["de"]="Dieses Passwort im VELO-Tresor speichern?",["zh"]="将此密码保存到 VELO Vault？",["ru"]="Сохранить пароль в VELO Vault?",["ja"]="このパスワードをVELO Vaultに保存？" },
        ["autofill.save"]                = new() { ["es"]="Guardar",["en"]="Save",["pt"]="Salvar",["fr"]="Enregistrer",["de"]="Speichern",["zh"]="保存",["ru"]="Сохранить",["ja"]="保存" },
        ["autofill.saved"]               = new() { ["es"]="Contraseña guardada en Vault.",["en"]="Password saved to Vault.",["pt"]="Senha salva no Vault.",["fr"]="Mot de passe enregistré dans le coffre.",["de"]="Passwort im Tresor gespeichert.",["zh"]="密码已保存到 Vault。",["ru"]="Пароль сохранён в Vault.",["ja"]="パスワードをVaultに保存しました。" },
        ["autofill.updated"]             = new() { ["es"]="Contraseña actualizada en Vault.",["en"]="Password updated in Vault.",["pt"]="Senha atualizada no Vault.",["fr"]="Mot de passe mis à jour dans le coffre.",["de"]="Passwort im Tresor aktualisiert.",["zh"]="Vault 中的密码已更新。",["ru"]="Пароль обновлён в Vault.",["ja"]="Vaultのパスワードを更新しました。" },
        ["autofill.breached"]            = new() { ["es"]="⚠ Esta contraseña aparece en {0} filtraciones conocidas. Considera cambiarla.",["en"]="⚠ This password appears in {0} known breaches. Consider changing it.",["pt"]="⚠ Esta senha aparece em {0} vazamentos conhecidos. Considere trocá-la.",["fr"]="⚠ Ce mot de passe apparaît dans {0} fuites connues. Pensez à le changer.",["de"]="⚠ Dieses Passwort taucht in {0} bekannten Datenlecks auf. Bitte ändern.",["zh"]="⚠ 此密码出现在 {0} 次已知泄漏中，建议更改。",["ru"]="⚠ Этот пароль найден в {0} известных утечках. Лучше сменить.",["ja"]="⚠ このパスワードは{0}件の漏洩に含まれます。変更を検討してください。" },
    };
}
